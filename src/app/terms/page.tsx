      ...
      <main className="max-w-3xl mx-auto px-4 md:px-6 py-16 md:py-24">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-sm text-slate-500 max-w-md mx-auto leading-relaxed">
            Our terms and conditions govern your use of JSK Enterprises services and outline your rights and obligations.
          </p>
        </div>
        ...
        <div className="border border-slate-100 rounded-2xl shadow-md p-8 md:p-10 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <h2 className="text-base font-semibold text-slate-900 mb-1">JSK Terms &amp; Conditions</h2>
            <p className="text-xs text-slate-400">JSK_Terms_Conditions.docx</p>
          </div>
          <a
            href="/JSK_Terms_Conditions.docx"
            download="JSK_Terms_Conditions.docx"
